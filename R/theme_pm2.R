theme_pm2 <- function(...){
  ...
  theme (
    ...
    panel.grid.major = element_line(color='grey85',linetype=2,size=0.5), # remove major grid
    panel.grid.minor = element_line (color='grey90',linetype=2), # remove minor grid
